...
(cl:defmethod cl:initialize-instance :after ((m <TwoInts>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TwoInts)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name project1-msg:<TwoInts> is deprecated: use project1-msg:TwoInts instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <TwoInts>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project1-msg:a-val is deprecated.  Use project1-msg:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <TwoInts>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project1-msg:b-val is deprecated.  Use project1-msg:b instead.")
  (b m))
